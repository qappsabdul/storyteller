...
const generateStoryFromImage = async (req, res) => {
    try {
        ...
        const prompt = `Generate a creative story based on this image. Be descriptive and imaginative about what you see in the image and craft a compelling narrative around it. The story should be approximately 300-500 words.
